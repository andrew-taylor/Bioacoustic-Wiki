// JavaScript for observations metadata, observations plugin.
...
YAHOO.util.Event.addListener(window, "load", function() {
    ...
    var nestedColumnDefs = [
        ...
        {key: "recording_notes", label: "Recording Notes", resizeable: true}
    ];
    ...
    var fields = [ "index", "type", "user", "recordist", {key: "date", parser: "date"},
                   ...
                   "location", "duration", "recordingquality", "fg_species", "bg_species",
                   "recording_notes", "PLAYURL", "MP3URL", "EDITURL", "USERURL" ];
